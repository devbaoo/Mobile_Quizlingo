import { fetchUserProfile, updateProfile } from "@/services/slices/user/userSlice";
...
const styles = StyleSheet.create({
  ...
  avatarWrapper: { width: 120, height: 120, borderRadius: 60, borderWidth: 4, borderColor: "#2563eb", justifyContent: "center", alignItems: "center", overflow: "hidden" },
